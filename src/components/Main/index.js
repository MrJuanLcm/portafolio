          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-500 leading-relaxed">
                ...
                en la construcción de aplicaciones web modernas, responsivas y
                escalables que utilizan las últimas tecnologías y mejores prácticas.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  ...
                  <span className="span">juanluislcm@gmail.com</span>
                </li>
                <li className="flex items-center gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="text-black span">+58 424-1778808</span>
                </li>
                <li className="flex items-center gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="text-black span">Venezuela</span>
                </li>
              </ul>
            </div>
          </div>
